...
urlpatterns = [
    ...
    path('home/', main.views.ChangeHomeView.as_view(), name='my_home'),
    path('profile/', main.views.ChangeProfileView.as_view(), name='profile'),

    path('accounts/login/', accounts.views.SignInView.as_view(), name='login'),

    path('search/', main.views.SearchView.as_view(), name='search'),
